export const BRAND = {
  ...
  googleMapsUrl:
    "https://www.google.com/maps/search/?api=1&query=Trade+House+Experience+Studio+IGS+Square+South+Janatha+Road+Palarivattom+Kochi+Kerala+682025",
};
...
export const JOURNAL_ARTICLES = [
  {
    ...
    date: "September 2025",
    summary:
      "Why traditional grid lighting is obsolete, and how architectural layering transforms tropical residences from ordinary to extraordinary.",
    image:
      "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=85",
    content: `
  ...
  },
  {
    ...
    title:
      "Warm vs Cool Light: How Color Temperature (CCT) Alters Mood and Rest",
    category: "Homeowners",
    readTime: "4 min read",
    date: "August 2025",
    summary:
      "Demystifying Kelvin ratings from 1800K to 6500K. Learn which color temperature belongs in each room of your home.",
    image:
      "https://images.unsplash.com/photo-1507089947368-19c1da9775ae?auto=format&fit=crop&w=1200&q=85",
    content: `
  ...
  },
  {
    ...
    date: "July 2025",
    summary:
      "DALI-2, Casambi, wireless mesh, and designer keypads: how to build future-proof smart lighting into your new Kochi villa.",
    image:
  ...
  },
  {
    ...
    date: "June 2025",
    summary:
      "Experience light before you specify it. Why our Kalloor lighting studio is designed as an architectural laboratory.",
    image:
      "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=1200&q=85",
    content: `
...
export const SIMULATOR_SPACES = [
  {
    id: "living-room",
    name: "Living Room & Salon",
    category: "Residential Architecture",
    subtitle: "Layered volume, warm conversational ambience & art grazing",
    image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1600&q=85",
    baseLux: 260,
    criRating: "98+",
    designNote: "Avoid flat ceiling arrays. Keep downlights offset to wash surfaces, allowing the perimeter cove to softly define the room's ceiling height.",
    fixtures: [
      {
        id: "downlights",
        name: "Trimless Downlights",
        type: "spot",
        label: "Ceiling Spots (24°)",
        spec: "Deep-baffle anti-glare UGR < 10",
        hotspot: { x: 38, y: 18 },
        defaultState: true,
        defaultIntensity: 75,
      },
      {
        id: "cove",
        name: "Perimeter Cove Light",
        type: "cove",
        label: "Indirect Ceiling LED Linear",
        spec: "Seamless 2400K–3000K warm dimming",
        hotspot: { x: 82, y: 12 },
        defaultState: true,
        defaultIntensity: 85,
      },
      {
        ...
        type: "pendant",
        label: "Bespoke Dining / Central Chandelier",
        spec: "Hand-blown satin brass fixture",
        hotspot: { x: 48, y: 32 },
        defaultState: true,
        defaultIntensity: 65,
      },
      {
        id: "accent",
        name: "Floor Lamp & Art Wash",
        type: "accent",
        label: "Lounge Reading Light & Art Grazer",
        spec: "Directional asymmetric beam",
        hotspot: { x: 18, y: 64 },
        defaultState: false,
        defaultIntensity: 60,
      },
    ...
    presets: [
      {
        id: "evening",
        name: "Golden Evening",
        desc: "Warm relaxed mood with soft ambient glow and glowing decorative centerpiece",
        cct: 2400,
        masterBrightness: 75,
        states: { downlights: true, cove: true, pendant: true, accent: false },
        intensities: { downlights: 40, cove: 90, pendant: 70, accent: 50 },
      },
      {
        id: "entertaining",
        name: "Entertaining & Hosting",
        desc: "Full architectural presentation balancing task clarity and celebratory radiance",
        cct: 3000,
        masterBrightness: 95,
        states: { downlights: true, cove: true, pendant: true, accent: true },
        intensities: { downlights: 85, cove: 80, pendant: 90, accent: 75 },
      },
      {
        id: "cinema",
        name: "Cinema & Late Night",
        desc: "Deep contrast chiaroscuro with zero glare on television and cozy low-level floor wash",
        cct: 2200,
        masterBrightness: 45,
        states: { downlights: false, cove: true, pendant: false, accent: true },
        intensities: { downlights: 0, cove: 35, pendant: 0, accent: 65 },
      },
      {
        id: "minimal",
        name: "Architectural Focus",
        desc: "Pure directional beams highlighting textures and geometry, cutting out ambient wash",
        cct: 3200,
        masterBrightness: 80,
        states: { downlights: true, cove: false, pendant: false, accent: true },
        intensities: { downlights: 90, cove: 0, pendant: 0, accent: 80 },
      },
    ],
  },
  {
    ...
    category: "Sanctuary Lighting",
    subtitle: "Circadian transition, glare-free bedside stems & soft headboard wash",
    image: "https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?auto=format&fit=crop&w=1600&q=85",
    baseLux: 180,
    criRating: "98 (R9 > 95)",
    designNote: "Eliminate direct downlights above the pillows. Rely on indirect vertical headboard grazing and narrow 8° bedside reading stems.",
    fixtures: [
      {
        id: "cove",
        name: "Headboard Cove Grazer",
        type: "cove",
        label: "Indirect Headboard Wall Linear",
        spec: "Concealed 2200K sunset dimming profile",
        hotspot: { x: 36, y: 38 },
        defaultState: true,
        defaultIntensity: 80,
      },
      {
        id: "pendant",
        name: "Bedside Reading Sconces",
        type: "pendant",
        label: "Micro-beam Switched Bedside Stems",
        spec: "Focused reading beam with zero pillow spill",
        hotspot: { x: 18, y: 48 },
        defaultState: true,
        defaultIntensity: 60,
      },
      {
        ...
        type: "spot",
        label: "Wardrobe & Perimeter Downlights",
        spec: "Dark-light deep aperture",
        hotspot: { x: 62, y: 16 },
        defaultState: false,
        defaultIntensity: 70,
      },
      {
        id: "accent",
        name: "Floating Floor Skimmer",
        type: "accent",
        label: "Night Pathway Base Lighting",
        spec: "Low-voltage motion-activated soft LED",
        hotspot: { x: 70, y: 84 },
        defaultState: true,
        defaultIntensity: 45,
      },
    ...
    presets: [
      {
        ...
        desc: "Ultra-warm ambient lighting engineered for melatonin production and restful sleep",
        cct: 2200,
        masterBrightness: 50,
        states: { cove: true, pendant: false, downlights: false, accent: true },
        intensities: { cove: 60, pendant: 0, downlights: 0, accent: 40 },
      },
      {
        id: "reading",
        name: "Bedtime Reading",
        desc: "Narrow focused reading light without disturbing sleeping partner or causing eye strain",
        cct: 2700,
        masterBrightness: 65,
        states: { cove: true, pendant: true, downlights: false, accent: false },
        intensities: { cove: 35, pendant: 85, downlights: 0, accent: 0 },
      },
      {
        id: "morning",
        name: "Morning Vitality",
        desc: "Invigorating natural color spectrum to awaken the space and dress for the day",
        cct: 3800,
        masterBrightness: 90,
        states: { cove: true, pendant: true, downlights: true, accent: false },
        intensities: { cove: 90, pendant: 60, downlights: 85, accent: 0 },
      },
      {
        id: "minimal",
        name: "Pathway Only",
        desc: "Subtle architectural floor skim for discreet nighttime navigation",
        cct: 2200,
        masterBrightness: 30,
        states: { cove: false, pendant: false, downlights: false, accent: true },
        intensities: { cove: 0, pendant: 0, downlights: 0, accent: 70 },
      },
    ],
  },
  {
    id: "dining-room",
    name: "Formal Dining Suite",
    category: "Hospitality & Dining",
    subtitle: "Emotional center, rich gastronomic color fidelity & table drama",
    image: "https://images.unsplash.com/photo-1617806118233-18e1de247200?auto=format&fit=crop&w=1600&q=85",
    baseLux: 300,
    criRating: "97+",
    designNote: "The chandelier is decorative jewelry; pair it with tight 15° pinspots precisely aimed at tableware and floral arrangements to create sparkle without glare.",
    fixtures: [
      {
        id: "pendant",
        name: "Centerpiece Chandelier",
        type: "pendant",
        label: "Suspended Glass & Brass Luminaire",
        spec: "Sculptural multi-drop diffuse fixture",
        hotspot: { x: 50, y: 35 },
        defaultState: true,
        defaultIntensity: 85,
      },
      {
        id: "downlights",
        name: "Table Accent Pinspots",
        type: "spot",
        label: "Narrow-Beam Downlights (15°)",
        spec: "Highlights cutlery, glassware and centerpieces",
        hotspot: { x: 44, y: 15 },
        defaultState: true,
        defaultIntensity: 80,
      },
      {
        id: "cove",
        name: "Perimeter Contour Cove",
        type: "cove",
        label: "Ceiling Perimeter Floating Channel",
        spec: "Creates gentle vertical wall bounce",
        hotspot: { x: 80, y: 10 },
        defaultState: true,
        defaultIntensity: 60,
      },
      {
        id: "accent",
        name: "Sideboard Art Wall Grazer",
        type: "accent",
        label: "Asymmetric Wall Washer",
        spec: "Reveals artwork and stone credenza texture",
        hotspot: { x: 88, y: 45 },
        defaultState: false,
        defaultIntensity: 70,
      },
    ...
    presets: [
      {
        ...
        desc: "Rich candlelit dining ambience making cuisine look delectable and faces warm",
        cct: 2200,
        masterBrightness: 70,
        states: { pendant: true, downlights: true, cove: false, accent: true },
        intensities: { pendant: 70, downlights: 55, cove: 0, accent: 60 },
      },
      {
        id: "gala",
        name: "Celebration Gala",
        desc: "All layers harmonized for lively dinners, cocktail parties, and festive celebrations",
        cct: 2800,
        masterBrightness: 95,
        states: { pendant: true, downlights: true, cove: true, accent: true },
        intensities: { pendant: 95, downlights: 85, cove: 80, accent: 75 },
      },
      {
        id: "contemporary",
        name: "Gallery Mood",
        desc: "Emphasis on architectural artwork and centerpiece pinspots with dim background",
        cct: 3000,
        masterBrightness: 65,
        states: { pendant: false, downlights: true, cove: false, accent: true },
        intensities: { pendant: 0, downlights: 90, cove: 0, accent: 90 },
      },
      {
        id: "casual",
        name: "Family Breakfast",
        desc: "Clean, daylight balanced illumination for morning energy and clarity",
        cct: 3600,
        masterBrightness: 85,
        states: { pendant: true, downlights: true, cove: true, accent: false },
        intensities: { pendant: 60, downlights: 80, cove: 90, accent: 0 },
      },
    ],
  },
  {
    id: "kitchen",
    name: "Culinary Kitchen & Island",
    category: "Task & Social Space",
    subtitle: "High CRI 98 food preparation, island social warmth & plinth skimmers",
    image: "https://images.unsplash.com/photo-1556911220-e15b29be8c8f?auto=format&fit=crop&w=1600&q=85",
    baseLux: 420,
    criRating: "98+",
    designNote: "Countertop shadows ruin cooking precision. Under-cabinet linear lighting combined with island task pendants eliminates work shadow while keeping ambient soft.",
    fixtures: [
      {
        id: "pendant",
        name: "Island Linear Pendants",
        type: "pendant",
        label: "Marble Island Hanging Fixtures",
        spec: "Warm downward spread with satin finish",
        hotspot: { x: 45, y: 38 },
        defaultState: true,
        defaultIntensity: 85,
      },
      {
        id: "downlights",
        name: "Ceiling Task Downlights",
        type: "spot",
        label: "Grid-Free Focused Task Spots",
        spec: "High lumen output with anti-glare louvers",
        hotspot: { x: 55, y: 15 },
        defaultState: true,
        defaultIntensity: 90,
      },
      {
        id: "cove",
        name: "Under-Cabinet Profile",
        type: "cove",
        label: "Shadow-Free Countertop Linear",
        spec: "Dot-free continuous milky diffuser",
        hotspot: { x: 80, y: 48 },
        defaultState: true,
        defaultIntensity: 95,
      },
      {
        id: "accent",
        name: "Island Toe-Kick Skimmer",
        type: "accent",
        label: "Floating Cabinet Plinth LED",
        spec: "Indirect floor skimming channel",
        hotspot: { x: 46, y: 88 },
        defaultState: false,
        defaultIntensity: 65,
      },
    ...
    presets: [
      {
        id: "prep",
        name: "Chef Prep & Cooking",
        desc: "Shadow-free task precision rendering ingredients with high CRI 98 fidelity",
        cct: 3600,
        masterBrightness: 100,
        states: { pendant: true, downlights: true, cove: true, accent: false },
        intensities: { pendant: 80, downlights: 100, cove: 100, accent: 0 },
      },
      {
        id: "social",
        name: "Wine & Island Social",
        desc: "Transforms the kitchen into an intimate entertaining bar for cocktails and charcuterie",
        cct: 2400,
        masterBrightness: 70,
        states: { pendant: true, downlights: false, cove: true, accent: true },
        intensities: { pendant: 90, downlights: 0, cove: 40, accent: 85 },
      },
      {
        id: "midnight",
        name: "Midnight Snack",
        desc: "Gentle floor and under-counter glow that won't jolt night vision",
        cct: 2200,
        masterBrightness: 40,
        states: { pendant: false, downlights: false, cove: true, accent: true },
        intensities: { pendant: 0, downlights: 0, cove: 50, accent: 70 },
      },
      {
        id: "clean",
        name: "Architectural Showcase",
        desc: "Clean linear geometry emphasizing the marble veining and minimalist joinery",
        cct: 3000,
        masterBrightness: 85,
        states: { pendant: true, downlights: true, cove: true, accent: true },
        intensities: { pendant: 70, downlights: 80, cove: 80, accent: 60 },
      },
    ],
  },
];
